...
namespace BinaryDecisionDiagram
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double naszeI = (g.Entropy(g.n1, g.n) + g.Entropy(g.n1, g.n) + g.Entropy(g.n1, g.n) + g.Entropy(g.n1, g.n));
            ...
            int desiredRow = 0;
            int columns = g.CountWantedColumns(desiredRow);
            ...
            Console.WriteLine("entropia po potwierdzeniu, czy mamy towarzysza (warunek 1+): " + entropyWarunek1plus);
            Console.WriteLine("entropia po zaprzeczeniu, czy mamy towarzysza (warunek 1-): " + entropyWarunek1minus);
            ...
            Console.WriteLine("I - E1: " + (naszeI - naszeE1));
        }
    }
}
